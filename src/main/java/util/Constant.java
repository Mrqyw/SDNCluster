...
public class Constant {
    ...
    public static final String GML_EDGE_STRING = "edge";
    public static final String GML_EDGE_SOURCE_STRING = "source";
    public static final String GML_EDGE_TARGET_STRING = "target";
    public static final String GML_END_STRING = "]";
